...
public class DoctorController {
    ...
    @PostMapping()
    public DoctorResponse createDoctor(@RequestBody @Valid CreateDoctorRequest request) {
    ...
    @PutMapping("/{id}")
    public DoctorResponse updateDoctor(@PathVariable Long id, @RequestBody @Valid UpdateDoctorRequest request) {
